...
public class LoadObject {
	...
	public static void main(String[] args) {
		...
		try (factory; session) {
			...
			Locker locker = session.load(Locker.class, 1);//here poxyObject object is not returned because it direct interact with data base
			...
			System.out.println(locker.getLockerId());//it print the locker id from the real object 
