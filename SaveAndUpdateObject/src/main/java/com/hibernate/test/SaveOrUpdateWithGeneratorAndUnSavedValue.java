...
public class SaveOrUpdateWithGeneratorAndUnSavedValue {
	...
	public static void main(String[] args) {
		...
		// Get the Session object for Connection between the Hibernate and client
		// application
		...
		try (factory; session) {
			...
			locker.setLockerId(2);
			locker.setLockerPass("SRaban@123");
			locker.setPerson("SRabna Panda");
